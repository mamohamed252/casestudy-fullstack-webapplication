	...
	<div class="container" style="padding-top: 10%">
		<div class="row">
			...
			<div class="col-5"
				...
				<label for="heroName">Hero Name:</label> <select
					value="${finding.heroName}" name="heroName">
				...
				<br>
				<br>
				<br> <label for="locationName">Location Name:</label> <select
					value="${finding.locationName}" name="locationName">
				...
				<br>
				<br>
				<br> <label for="orgName">Org Name:</label> <select
					value="${finding.orgName}" name="orgName">
				...
				<br>
				<br>
				<br> <label for="start">Start date:</label> <input type="date"
