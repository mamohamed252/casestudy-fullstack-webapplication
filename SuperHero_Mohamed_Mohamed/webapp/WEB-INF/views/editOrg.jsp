  ...
  <div class="container">
    ...
    <div class="col-md-auto">
      <div class="text-center">
        <img src='/SuperHero_Mohamed_Mohamed/resources/img/edit.png' class="featurette-image img-fluid mx-auto" alt="resonsive image" width="650px"
          height="500px">
      </div>
    </div>
    <div class="col-md-6">
  ...
  <div class="row">
    <table id="contactTable" class="table table-hover">
                <tr>
                    ...
                    <th width="20%"> <h4><a href="editOrg.html">Edit/Delete</a></h4></th>
                </tr>
