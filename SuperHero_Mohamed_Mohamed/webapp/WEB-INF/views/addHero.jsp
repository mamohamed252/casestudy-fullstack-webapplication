			...
			<div class="container" style="padding-top: 5%">
				<div class="row">
					...
					<div class="col-6"
						...
						<h1>Add New Superhero or Villan</h1>
						<form action="createHero" method="post"
							style="display: flex; flex-direction: column">
							Hero or Villan: <input type="text" class="form-control"
								name=heroStatus placeholder="Name" required /><br> 
								Name: <input type="text" class="form-control" name=heroName
								placeholder="Name" required /><br>
							<label for="sel1">Organizations:</label> <select
