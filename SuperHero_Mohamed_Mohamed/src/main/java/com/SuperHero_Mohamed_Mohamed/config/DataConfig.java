package com.SuperHero_Mohamed_Mohamed.config;
...
@EnableJpaRepositories("com.SuperHero_Mohamed_Mohamed.repo")
...
public class DataConfig {
	...
	public LocalContainerEntityManagerFactoryBean getEntityManagerFactoryBean() {
		...
		emfBean.setPersistenceUnitName("SuperHero_Mohamed_Mohamed");
		emfBean.setPackagesToScan("com.SuperHero_Mohamed_Mohamed.entity");
