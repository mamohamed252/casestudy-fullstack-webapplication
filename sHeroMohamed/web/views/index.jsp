        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="parent d-flex justify-content-center">
              <img src="/sHeroMohamed/resources/img/welcome.jpg" class="image1">
                <div class="carousel-caption">
                  <h1 style="color: crimson;">Another example headline.</h1>
                  <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam.</p>
                  <p>
                  <p></p>Donec id elit non mi porta gravida at eget metus.</p>
          ...
          <div class="carousel-item">
            <div class="parent d-flex justify-content-center">
              <img src="/sHeroMohamed/resources/img/locationC.jpg" class="image2">
          ...
          <div class="carousel-item">
            <div class="parent d-flex justify-content-center">
              <img src="/sHeroMohamed/resources/img/mission.jpg" class="image3">
              <div class="carousel-caption">
                <h1 style="color: crimson;">Another example headline.</h1>
                <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam.</p>
                <p>
